...
class Analizador:
    ...
    def castMascara(self,area):
        ...
        if area in rotativosInyeccion or area in rotativosSoplado:
            ...
            diasLaborales = list(pd.date_range(self.fechaInicio,self.fechaFin + timedelta(days=1),freq='d'))
        ...
        for fecha in diasLaborales:
            ...
            if fecha not in diasOperario:
                ...
                self.frameEnAnalisis = self.frameEnAnalisis.append({'Legajo':legajo,'Nombre':nombre,
        ...
        self.frameEnAnalisis['Fecha'] = pd.to_datetime(self.frameEnAnalisis['Fecha']).dt.date 
        self.frameEnAnalisis = self.frameEnAnalisis.sort_values(by=['Fecha'])                                                  
                    ...
                    if self.frameEnAnalisis.iloc[renglon,posicion+ 1] == cero and dia != 'Sábado':
                            if posicion <6:
                                if self.frameEnAnalisis.iloc[renglon +1,3] == fecha +timedelta(days=1):# Verifica que el proximo dia en donde se va a sacar el datos sea un dia siguiente.-
                                    print(turnoNocheIngreso - timedelta(hours=5),'   ',turnoNocheIngreso + timedelta(hours=5))
                                    if (turnoNocheIngreso - timedelta(hours=5)) <= self.frameEnAnalisis.iloc[renglon,posicion] <= (turnoNocheIngreso + timedelta(hours=5)) :
                                        if self.frameEnAnalisis.iloc[renglon +1,posicion] >= turnoMañanaIngresoTomorrow:                                    
                                            ...
                                            msg = 'Acomodando legajo {}, dia de analisis: {},Condicion UNO'.format(self.frameEnAnalisis.iloc[renglon,0],fecha)
                                            logger.info(msg)
                                            break
                                        ...
                                        if  (turnoTardeEgreso - timedelta(hours=2)) <= self.frameEnAnalisis.iloc[renglon+ 1,posicion] <= (turnoTardeEgreso + timedelta(hours=2)):
                                            ...
                                            if str(self.fechaFin) == str(fecha):
                                                self.frameEnAnalisis.iloc[renglon,posicion+ 2] = cero
                                            msg = 'Acomodando legajo {}, dia de analisis: {},Condicion DOS'.format(self.frameEnAnalisis.iloc[renglon,0],fecha)
                                            logger.info(msg)
                                            
                                        else:
                                            break
                                    
                                    elif self.frameEnAnalisis.iloc[renglon- 1,posicion +2] != ceroAyer and \
                                        self.frameEnAnalisis.iloc[renglon,3] - self.frameEnAnalisis.iloc[renglon -1,3] < timedelta(days=1,hours=1):
                                       ...
                                       if str(self.fechaFin) == str(fecha):
                                           self.frameEnAnalisis.iloc[renglon,posicion+ 2] = cero
                                       msg = 'Acomodando legajo {}, dia de analisis: {},Condicion TRES'.format(self.frameEnAnalisis.iloc[renglon,0],fecha)
                                       logger.info(msg)
                        ...
                        if posicion <6:
                            ...
                            if self.frameEnAnalisis.iloc[renglon- 1,posicion +2] == ceroAyer:
                                ...
                                if  turnoMañanaIngreso - timedelta(minutes=10) <= self.frameEnAnalisis.iloc[renglon,posicion] <= turnoMañanaIngreso + timedelta(hours=2) and \
                                    (self.frameEnAnalisis.iloc[renglon,posicion +1] > (turnoTardeIngreso + timedelta(hours=3)) or \
                                     self.frameEnAnalisis.iloc[renglon,posicion +1] == cero):  
                                        ...
                                        if str(self.fechaFin) == str(fecha):
                                            self.frameEnAnalisis.iloc[renglon,posicion+ 2] = cero    
                                        msg = 'Acomodando legajo {}, dia de analisis: {},Condicion CUATRO'.format(self.frameEnAnalisis.iloc[renglon,0],fecha)
                                        logger.info(msg)
                                        break
                                    ...
                                    (self.frameEnAnalisis.iloc[renglon,posicion +1] > (turnoTardeIngreso - timedelta(hours=2)) or \
                                      self.frameEnAnalisis.iloc[renglon,posicion +1] == cero):  
                                        ...
                                        if str(self.fechaFin) == str(fecha):
                                            self.frameEnAnalisis.iloc[renglon,posicion+ 2] = cero    
                                        msg = 'Acomodando legajo {}, dia de analisis: {},Condicion CINCO'.format(self.frameEnAnalisis.iloc[renglon,0],fecha)
                                        logger.info(msg)
                                ...
                                #Parte Nuevaaaaa
                                if turnoMañanaIngreso < self.frameEnAnalisis.iloc[renglon,posicion] < turnoMañanaIngreso + timedelta(hours=1) and \
                                   self.frameEnAnalisis.iloc[renglon,posicion] < turnoMañanaIngreso + timedelta(hours=1) and \
                                   self.frameEnAnalisis.iloc[renglon,posicion +1] > (turnoTardeIngreso + timedelta(hours=3)):
                                       ...
                                       if str(self.fechaFin) == str(fecha):
                                           self.frameEnAnalisis.iloc[renglon,posicion+ 2] = cero
                                       msg = 'Acomodando legajo {}, dia de analisis: {},Condicion SEIS'.format(self.frameEnAnalisis.iloc[renglon,0],fecha)
                                       logger.info(msg)
                                       break
                                    ...
                                    (self.frameEnAnalisis.iloc[renglon,posicion +1] > (turnoTardeIngreso + timedelta(hours=3)) or \
                                     self.frameEnAnalisis.iloc[renglon,posicion +1] == cero):  
                                        ...
                                        if str(self.fechaFin) == str(fecha):
                                            self.frameEnAnalisis.iloc[renglon,posicion+ 2] = cero
                                        msg = 'Acomodando legajo {}, dia de analisis: {},Condicion SIETE'.format(self.frameEnAnalisis.iloc[renglon,0],fecha)
                                        logger.info(msg)
                                        break
                                
                                elif turnoNocheIngreso - timedelta(days=1) < self.frameEnAnalisis.iloc[renglon,posicion] < turnoMañanaIngreso - timedelta(hours=3)  and \
                                    (self.frameEnAnalisis.iloc[renglon,posicion +1] > (turnoTardeIngreso - timedelta(hours=2)) or \
                                      self.frameEnAnalisis.iloc[renglon,posicion +1] == cero):  
                                        ...
                                        if str(self.fechaFin) == str(fecha):
                                            self.frameEnAnalisis.iloc[renglon,posicion+ 2] = cero
                                        msg = 'Acomodando legajo {}, dia de analisis: {},Condicion OCHO'.format(self.frameEnAnalisis.iloc[renglon,0],fecha)
                                        logger.info(msg)
                                        break
                                    ...
                                    logger.info('no estoy pasando por ninguna lado')
                        ...
                        if self.frameEnAnalisis.iloc[renglon,posicion+ 1] == cero and dia != 'Sábado':
                            ...
                            if posicion <6:
                                if self.frameEnAnalisis.iloc[renglon- 1,posicion +2] == ceroAyer:
                                    ...
                                    # print(cero - timedelta(hours=1),self.frameEnAnalisis.iloc[renglon,posicion],cero + timedelta(hours=3))
                                    # print((turnoTardeIngreso - timedelta(hours=2)),turnoTardeIngreso + timedelta(hours=3),' ',self.frameEnAnalisis.iloc[renglon,posicion + 1])
                                #      self.frameEnAnalisis.iloc[renglon,posicion +1] == cero))
                                    if  (cero - timedelta(hours=2) < self.frameEnAnalisis.iloc[renglon,posicion] < cero + timedelta(hours=3)) and \
                                        (turnoTardeIngreso - timedelta(hours=2) < self.frameEnAnalisis.iloc[renglon,posicion +1] < turnoTardeIngreso + timedelta(hours=2) or \
                                          self.frameEnAnalisis.iloc[renglon,posicion +1] == cero):
    ...
    def borradoCeros(self):
        ...
        columnas = [ 'Legajo','Nombre','Dia','Fecha',
    ...
    def horasTrabajadasRotativos(self,frame,area,mediosDias=[]):
        ...
        for fila in range(len(frame)):
            if area in rotativosInyeccion:       
                    ...
                    for idx in range(4,14,2):
                        if frame.iloc[fila,idx + 1] == pd.to_datetime(('{} 00:00').format(fecha)) and frame.iloc[fila,idx] != pd.to_datetime(('{} 00:00').format(fecha)):
                            ...
                            if dia == 'Sábado':
                                ...
                                #     frame.iloc[fila,idx] < turnoNocheIngreso + timedelta(hours=4,minutes=30): #Tercer Turno
                                elif frame.iloc[fila,idx] > turnoNocheIngreso - timedelta(hours=5) and \
                                    frame.iloc[fila,idx] < turnoNocheIngreso + timedelta(hours=5): #Tercer Turno
                    ...
                    frame.iloc[fila,16] = horas_trabajadas
            else:
            ...
            if area in rotativosInyeccion:
                ...
                if dia == 'Sábado':
                    ...
                    if ingresoOperario < turnoMañanaPrimerIngreso - timedelta(hours=5):
                        ...
                        minutosExtras50 += frame.iloc[fila,16]
                    ...
                    if fechaIngreso in feriados and fechaSalidaOperarios not in feriados: 
                        ...
                        if  turnoNocheIngreso- timedelta(hours=5) < ingresoOperario < turnoNocheIngreso:
                            if ingresoOperario < turnoNocheIngreso:                                                     
                                minutosExtras50 += ((cero - ingresoOperario).seconds)/3600
                        ...
                        if salidaOperario > cero:
                            minutosExtras50 += ((salidaOperario - cero).seconds)/3600
                            # frame.iloc[fila,18] = round(minutosExtras100,2)
                            # frame.iloc[fila,16] = 0
                        if ingresoOperario < turnoNocheIngreso:
                            minutosExtras50 += ((turnoNocheIngreso - ingresoOperario).seconds)/3600 
                            ...
                            if turnoMañanaPrimerIngreso- timedelta(hours=2) < ingresoOperario < turnoMañanaPrimerIngreso + timedelta(hours = 1):
                                if ingresoOperario < turnoMañanaPrimerIngreso:                                                     
                                    ...
                                    if salidaOperario > salidaMedioDia:
                                        ...
                                        frame.iloc[fila,18] = round(minutosExtras100,2)
                                        frame.iloc[fila,16] = round(((salidaMedioDia - turnoMañanaPrimerIngreso).seconds)/3600,2)
                                    else:
                                        frame.iloc[fila,16] = round(((salidaOperario - turnoMañanaPrimerIngreso).seconds)/3600,2)
                                
                                else:
                                    if salidaOperario > salidaMedioDia:
                                        minutosExtras100 += ((salidaOperario - salidaMedioDia).seconds)/3600 
                                        frame.iloc[fila,16] = round(((salidaMedioDia - ingresoOperario).seconds)/3600,2)
                                    else:
                            ...
                            if turnoNocheIngreso- timedelta(hours=2) < ingresoOperario < turnoNocheIngreso + timedelta(hours = 1):
                                if ingresoOperario < turnoNocheIngreso:                                                     
                                   pass
                                    ...
                                    if salidaOperario > turnoNocheSalida:
                                        minutosExtras50 += ((salidaOperario - turnoNocheSalida).seconds)/3600 
                                        frame.iloc[fila,16] = round(((turnoNocheSalida - ingresoOperario).seconds)/3600,2)
                                    else:
                                        frame.iloc[fila,16] = round(((salidaOperario - ingresoOperario).seconds)/3600,2)
                ...
                if minutosExtras50 > 4 and dia != 'Sábado':
                    minutosExtras50 = 4
                frame.iloc[fila,17] = round(minutosExtras50,2) #Asigna las horas extras al 50%
                ...
                if fechaSalidaOperarios in feriados or fechaIngreso in feriados:
                    ...
                    if fechaIngreso in feriados and fechaSalidaOperarios not in feriados:                    
                        if  turnoNocheIngreso- timedelta(hours=5) < ingresoOperario < turnoNocheIngreso:
                            ...
                            if salidaOperario > turnoNocheSalida:
                                minutosExtras50 += ((salidaOperario - turnoNocheSalida).seconds)/3600
                                frame.iloc[fila,16] = round(((turnoNocheSalida - cero).seconds)/3600,2)
                            else:
                                frame.iloc[fila,16] = round(((salidaOperario - cero).seconds)/3600,2)                         
                ...
                if fechaSalidaOperarios in mediosDias or fechaIngreso in mediosDias:
                    if  turnoNocheIngreso- timedelta(hours=5) < ingresoOperario < turnoNocheIngreso:
                        if ingresoOperario < turnoNocheIngreso:                                                      
                            minutosExtras50 += ((turnoNocheIngreso - ingresoOperario).seconds)/3600
                    ...
                    if salidaOperario > turnoNocheSalida:
                        ...
                        if salidaMedioDia < ingresoOperario < turnoTardeIngreso:
                            ...
                            frame.iloc[fila,18] = round(((salidaOperario - ingresoOperario ).seconds)/3600,2)
                            frame.iloc[fila,16] = 0
    ...
    def restaRetrasosTardanzas(self,frame,mediosDias=[]):
        ...
        for x in range(len(frame)):
                ...
                if frame.iloc[x,4] > horaIngreso:
                    tardanza = round((((frame.iloc[x,4] - horaIngreso).seconds)/60),2)               
        ...
        try:
            ...
            for legajo in legajosSinMarca:
                ...
                if len(indexNoMarca) == 0:
                    ...
                    doc.add_heading(('Informe sobre {} ({}) ({}):').format(nombre,legajo,area),level=1)
                    c = doc.add_paragraph()
