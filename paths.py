...
areas = ['ARMADO','INYECCION','MOTORES','DEPOSITO','COMERCIAL','MECANIZADO',
         ...
         'MECANIZADO ROTATIVO', 'MOTORES ALUMINIO', 'MANGUERAS',
         ]
...
rotativosInyeccion = ['INYECCION','MECANIZADO ROTATIVO','MOTORES ALUMINIO','SOPLADO', 'MANGUERAS']
...
RETIRO ANTICIPADO EN HS,HS NO TRABAJADAS,LLEG TARDE,FALTAS INJUSTIFICADAS,FALTA JUSTIFICADA"'
